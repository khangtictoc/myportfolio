      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-10">
          {projectsData.data.map((project, index) => (
            <div
              key={index}
              className={`bg-white rounded-lg overflow-hidden shadow-custom-light transition-all duration-300 hover:shadow-custom-heavy p-6 lg:p-8 relative ${
            ...
            >
              ...
              {project.image && (
                <div
                  className="absolute bottom-4 right-4 w-16 h-16 lg:w-20 lg:h-20 bg-white rounded-lg p-2 animate-fadeIn"
              ...
              <div className="flex flex-col">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-4">
                  <h3
                    className="text-2xl font-bold text-primary animate-fadeIn"
                    style={{ animationDelay: `${0.3 + index * 0.2}s` }}
                  >
                    {project.name}
                  </h3>
                  <div
                    className="mt-2 lg:mt-0 text-sm text-text-light animate-fadeIn"
                ...
                <div
                  className="flex items-center mb-4 animate-fadeIn"
                ...
                <p
                  className="text-lg font-medium mb-2 animate-fadeIn"
                  style={{ animationDelay: `${0.6 + index * 0.2}s` }}
                >
                  {project.shortDescription}
                </p>
                <p
                  className="text-text-light mb-4 animate-fadeIn"
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      ...
                      style={{
                        animationDelay: `${0.8 + index * 0.2 + techIndex * 0.05}s`,
                      }}
                    >
                      {tech}
                    </span>
                      ...
                      {project.responsibilities.map(
                        (responsibility, respIndex) => (
                          <li
                            ...
                            style={{
                              animationDelay: `${0.2 + respIndex * 0.1}s`,
                            }}
                          >
                            {responsibility}
                          </li>
                ...
                {/* Links */}
                <div
                  className="flex gap-3 mt-6 animate-fadeIn"
